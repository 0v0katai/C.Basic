...
char   defaultListAry='l'-'A';
char   defaultListAryN=6;
char   defaultListArySize=64+1;
//----------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------
...
int SetMatrix(int select){		// ----------- Set Matrix
	...
	while (cont) {
		...
		for ( i=0; i<7; i++ ) {
			...
			locate( 6, 1+i); MatAryElementSizePrint( MatAry[k].ElementSize ) ;
			if ( MatAry[k].SizeA ) {
