...
void CB_DotGet( unsigned char *SRC ){	// DotGet(px1,py1, px2,py2)->Mat B [x,y]
	unsigned int c;
	int x,y,px,py;
	int px1,py1,px2,py2;
	char*	MatAryC;
...
void CB_DotPut( unsigned char *SRC ){	// DotPut(Mat B[x,y], px1,py1, px2,py2)
	unsigned int c;
	int x,y,px,py;
	int px1,py1,px2,py2;
	double	*Matary2;
...
void CB_DotTrim( unsigned char *SRC ){	// DotTrim(Mat A,x1,y1,x2,y2)->Mat B    =>[X,Y]
	unsigned int c;
	int x,y, px,py;
	int x1,y1,x2,y2;
	int px1,py1,px2,py2;
