...
int Bfile_FindFirst_NON_SMEM( unsigned short *pathname, int *FindHandle, unsigned short *foundfile, void *fileinfo );
...
int Bfile_FindNext_NON_SMEM( int FindHandle, unsigned short *foundfile, FILE_INFO *fileinfo );
