...
//---------------------------------------------------------------------------------------------
int KPrintCharMiniFX( int px, int py, unsigned char *str, int mode ) { // カナ対応 PrintMini FX or CG (0,-24)-(383,191)
    DISPGRAPH kfont;
    GRAPHDATA kfont_info;
    unsigned char *font;
    int a,b;
