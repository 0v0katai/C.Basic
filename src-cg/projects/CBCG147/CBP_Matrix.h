#define LISTMAX 52
#define MATARY_MAX 26+6+LISTMAX+26+1+3	// add vctx26 + ( + traceAry + ClipBuffer ) + PictBuffer
...
typedef struct {		// 32 bytes
	int		Maxbyte;	// 0>:Adrs redefinition
	char	Base;
	short	ElementSize;
	int		SizeA;
	int		SizeB;
...
extern char listdsp;	// Mat:0  list:1  vct:2
...
int DimMatrixSub( int reg, int ElementSize, int dimA, int dimB, int base ) ;	// 1-
