...
// Paint�T���v���v���O�����𗘗p�����Ē����Ă��܂��B

#define MAXSIZE	256 /* �o�b�t�@�T�C�Y */
...
struct BufStr buff[MAXSIZE]; /* �V�[�h�o�^�p�o�b�t�@ */
struct BufStr *sIdx, *eIdx;  /* buff�̐擪�E�����|�C���^ */

/*
  scanLine : ��������V�[�h��T�����ăo�b�t�@�ɓo�^����

  int lx, rx : ������X���W�͈̔�
  int y : ������Y���W
  int oy : �e���C����Y���W
  unsigned int col : �̈�F
*/
...
/*
  ...
  int x, y : �J�n���W
  unsigned int paintCol : �h��ׂ����̐F(�`��F)
*/
void ML_paint( int x, int y, ML_Color color )
{
  ...
  unsigned int col = ML_pixel_test( x, y ); /* �̈�̐F(�̈�F) */
  if ( col == paintCol ) return;    /* �̈�F�ƕ`��F����������Ώ����s�v */
