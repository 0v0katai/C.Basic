...
#define CMD_SHIFT_SKTCH_COLOR	0x921
...
double InputNumD(int x, int y, int width, double defaultNum, char* SPC, int rev_mode, int float_mode, int exp_mode, int *key );
...
void GetGenuineCmdF1( int *code );
void GetGenuineCmdF2( int *code );
void GetGenuineCmdF3( int *code );
...
extern int *OplistRecent;
extern toplistrecentfreq OplistRecentFreqMem[OpRecentFreqMax];
extern int OplistRecentMem[OpRecentMax];
